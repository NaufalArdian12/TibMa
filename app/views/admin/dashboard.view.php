                ...
                <div class="container flex items-center gap-4">
                    ...
                    <div class="ms-auto hs-dropdown relative inline-flex [--placement:bottom-right]">
                        <button type="button" class="hs-dropdown-toggle inline-flex items-center">
                            <img src="<?=  App::get("public_uri") ; ?>/img/flags/us.jpg" alt="user-image" class="h-4 w-6">
                        </button>
                        ...
                        <div
                            ...
                            <a href="javascript:void(0);"
                                ...
                                <img src="<?=  App::get("public_uri") ; ?>/img/flags/germany.jpg" alt="user-image" class="h-4">
                            ...
                            <a href="javascript:void(0);"
                                class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-default-800 hover:bg-gray-100">
                                <img src="<?=  App::get("public_uri") ; ?>/img/flags/italy.jpg" alt="user-image" class="h-4">
                            ...
                            <a href="javascript:void(0);"
                                class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-default-800 hover:bg-gray-100">
                                <img src="<?=  App::get("public_uri") ; ?>/img/flags/spain.jpg" alt="user-image" class="h-4">
                            ...
                            <a href="javascript:void(0);"
                                class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-default-800 hover:bg-gray-100">
                                <img src="<?=  App::get("public_uri") ; ?>/img/flags/russia.jpg" alt="user-image" class="h-4">
                    ...
                    <div class="relative">
                        <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                            <button type="button" class="hs-dropdown-toggle">
                                <img src="<?=  App::get("public_uri") ; ?>/img/users/avatar-8.jpg" alt="user-image" class="rounded-full h-10">
                            </button>
                            <div
                                class="hs-dropdown-menu duration mt-2 min-w-48 rounded-lg border border-default-200 bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 hidden">
                                ...
                                <hr class="my-2">
                                <a class="flex items-center py-2 px-3 rounded-md text-sm text-default-800 hover:bg-gray-100"
                                    href="<?=  App::get("public_uri") ; ?>/logout">
                                    Log Out
                                </a>
                            </div>
                        </div>
